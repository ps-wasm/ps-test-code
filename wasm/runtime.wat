(module
  (type $closure_arg_array (array (ref eq)))
  (type $closure_arg_array_mut (array (mut (ref null eq))))
  (type $closure_top (struct (field (ref func))(field (ref $closure_arg_array))))
  (type $classDict (array (mut (ref eq))))
  ...
  (type $func-param-clos (func (param (ref $closure_arg_array))(param (ref eq))(result (ref eq))))
  (type $func-clos (func (param (ref $closure_arg_array))(result (ref eq))))
  ...
  (func $addToArgArray (export "addToArgArray")
    ...
    (param $new-var (ref eq))
    (result (ref $closure_arg_array))
    (local $i i32)
    (local $len i32)
    (local $new-arr (ref $closure_arg_array_mut))
    ...
    i32.const 1
    i32.add
    array.new $closure_arg_array_mut
    local.set $new-arr
    ...
    (if
      (then
        (loop $arrayRunDown
          ...
          array.set $closure_arg_array_mut
  ...
  (func $apply (export "apply") (param $clos (ref $closure_top)) (param $arg (ref eq)) (result (ref eq))
