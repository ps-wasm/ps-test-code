...
(invoke "Test.testSum3" (i32.const 0))
(invoke "Test.testSum3" (i32.const 25))
(invoke "Test.testSum3" (i32.const 50))
(invoke "Test.testSum3" (i32.const 75))
(invoke "Test.testSum3" (i32.const 100))
(invoke "Test.testSum3" (i32.const 125))
