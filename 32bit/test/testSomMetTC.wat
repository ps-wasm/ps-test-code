(module
    ...
    (import "main" "Main.somMetTC" (func $Main.somMetTC (type $runtime.func-param-clos)))
    (import "main" "Wasm.EuclideanRing.euclideanRingNumber" (func $Wasm.EuclideanRing.euclideanRingNumber (type $runtime.const)))


    (elem declare func $Main.somMetTC)
    (elem declare func $Wasm.EuclideanRing.euclideanRingNumber)
    
    (func $Test.testSomMetTC (export "Test.testSomMetTC") (param f32) (param f32) (result f32)
      ref.func $Main.somMetTC
    ...
    ;; (func $Test.testSomMetTC (export "Test.testSomMetTC") (param i32) (result i32)
    ;;   ref.func $Main.somMetTC
    ;;   array.new_fixed $runtime.closure_arg_array 0
    ;;   call $runtime.newClosure
