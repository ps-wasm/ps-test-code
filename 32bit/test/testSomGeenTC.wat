(module
    ...
    (import "main" "Main.somGeenTC" (func $Main.somGeenTC (type $runtime.func-param-clos)))

    (elem declare func $Main.somGeenTC)
    (func $Test.testSomGeenTC (export "Test.testSomGeenTC") (param f32) (param f32) (result f32)
      ref.func $Main.somGeenTC
